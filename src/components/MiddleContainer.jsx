      ...
      <div class="row justify-content-between row-top">
        ...
        <div class="col-lg-6 col-12">
          ...
          <div class="col-xl-8 col-lg-10 col-8 align-self-start">
            <img src={containerImg} alt="middle-container-img" class="img-fluid mb-lg-0 mb-5 direction-img" />
          </div>
        </div>
      </div>
      <div class="row row-bottom">
        <TextBackground col='col-xl-5 col-lg-6' text="ÖNLEYİCİ AVUKATLIK" textAlign='text-start'/>
        <div class="col-xl-4 col-lg-6 col-7 text-center offset-lg-0 mb-lg-0 mb-5 offset-5">
          <Card 
            name="word-card"
            title="HESAP VEREBİLİRLİK    ŞEFFAFLIK"
          />
        </div>
      </div>
      <div class="row">
