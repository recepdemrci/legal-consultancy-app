      ...
      <div class="row justify-content-center">
        <div class="col-xl-4 d-none d-lg-block text-end align-self-center">
          <Card 
            ...
            title={<p>FİKRİ VE SANAT MÜLKİYET<br/>İŞ VE SOSYAL GÜVENLİK<br/>İCRA VE İFLAS<br/>TİCARET HUKUKU</p>}
          />
        </div>
        ...
        <div class="col-xl-4 col-md-6 col-8 text-center align-self-center">
          <Card 
            ...
            body={
              <p><br/>AVUKAT<br/>İSTANBUL<br/><br/>+90 532 660 02 85<br/>nurettinselcukozturk@gmail.com</p>
            }
          />
        </div>
      </div>
